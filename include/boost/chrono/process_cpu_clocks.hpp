...
namespace boost {
	...
	namespace chrono
	{
		...
		inline BOOST_CONSTEXPR
			bool
			operator==(const std::chrono::duration<process_times<Rep1>, Period1>& lhs,
				const std::chrono::duration<process_times<Rep2>, Period2>& rhs)
		{
		...
		public:
			...
			typedef std::chrono::duration<times, nano>                duration;
			typedef duration::rep                       rep;
			typedef duration::period                    period;
...
namespace std {
	namespace chrono {
	template <typename Rep>
	struct duration_values<boost::chrono::process_times<Rep> >
	{
